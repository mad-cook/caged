    ...
    return NextResponse.json(
      {
        ...
        lockFeeLamports: c.lock_fee_lamports.toString(),
        rewardFeeBps: c.reward_fee_bps,
        paused: c.paused,
        totalLocks: c.total_locks.toString(),
        totalLockFeesLamports: c.total_lock_fees.toString(),
        totalRewardFeesLamports: c.total_reward_fees.toString(),
        totalRewardsPaidLamports: c.total_rewards_paid.toString(),
        updatedAt: Date.now(),
      },
      { headers: CORS },
    );
